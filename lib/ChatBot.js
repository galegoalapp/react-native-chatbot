  ...
  triggerNextStep(data) {
    ...
    if (isEnd) {
      ...
      currentStep = Object.assign(
        ...
        {
          user: true,
          message: typeof option.label === "function" ? option.label() : option.label,
          trigger
        }
      );
  ...
  getInputText = () => {
    ...
    return (
      <>
        ...
        <Text style={{ backgroundColor: "rgba(208, 2, 27, 0.2)" }}>{textBeyondLimit}</Text>
      </>
    );
  }
  ...
  render() {
    ...
    return (
      <ChatBotContainer
        ...
        style={[style, { flexGrow: 1, position: "relative", height: height - topOffset }]}
      >
        <ImageBackground
            ...
            <Footer
              ...
              style={[
                footerStyle,
                {
                  minHeight: 61,
                  padding: 5,
                  paddingBottom: Platform.OS === "ios" ? topOffset + 20 : topOffset + 10,
                  display: "flex",
                  flexDirection: "row",
                  alignContent: "center",
                  alignItems: "center"
            ...
            >
              <View style={{ flexGrow: 1, width: 100 }}>
                ...
                {inputValue.length > (inputMaxLength - inputWarningThreshold) ? (
                  <Text style={[{ fontSize: 8, left: "90%" }, (inputValue.length > inputMaxLength) ? { color: "rgb(208, 2, 27)" } : {}]}>
              ...
              <View>
                <Button
                  ...
                  style={[submitButtonStyle, { minWidth: 80 }, (inputValue.length > inputMaxLength) ?  {  backgroundColor: "rgb(155,155,155)" } : {}]}
